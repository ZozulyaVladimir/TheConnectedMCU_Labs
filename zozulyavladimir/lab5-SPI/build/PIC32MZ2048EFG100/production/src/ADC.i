...
# 146 "src/ADC.c"
    ...
    ADCCMPEN1 = ADCCMPEN2 = 0;

    ADCCSS1 = ADCCSS2 = 0;

    ADCCMP1 = ADCCMP2 = ADCCMP3 = 0;
    ADCCMP4 = ADCCMP5 = ADCCMP6 = 0;

    ADCFLTR1 = ADCFLTR2 = ADCFLTR3 = 0;
    ADCFLTR4 = ADCFLTR5 = ADCFLTR6 = 0;
...
# 215 "src/ADC.c"
int convertWiFIREadc(__uint8_t channelNumber) {
# 314 "src/ADC.c"
    __uint32_t mask;
    ...
    return ((int) ((__uint32_t *) & ADCDATA0)[channelNumber]);
