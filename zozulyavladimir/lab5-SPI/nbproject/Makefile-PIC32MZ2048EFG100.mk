...
SOURCEFILES_QUOTED_IF_SPACED=src/OLED/ChrFont0.c src/OLED/FillPat.c src/OLED/OLED.c src/OLED/OledChar.c src/OLED/OledGrph.c src/OLED/SPI.c src/configuration_bits.c src/main.c src/user.c src/ADC.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/OLED/ChrFont0.o ${OBJECTDIR}/src/OLED/FillPat.o ${OBJECTDIR}/src/OLED/OLED.o ${OBJECTDIR}/src/OLED/OledChar.o ${OBJECTDIR}/src/OLED/OledGrph.o ${OBJECTDIR}/src/OLED/SPI.o ${OBJECTDIR}/src/configuration_bits.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/user.o ${OBJECTDIR}/src/ADC.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/src/OLED/ChrFont0.o ${OBJECTDIR}/src/OLED/FillPat.o ${OBJECTDIR}/src/OLED/OLED.o ${OBJECTDIR}/src/OLED/OledChar.o ${OBJECTDIR}/src/OLED/OledGrph.o ${OBJECTDIR}/src/OLED/SPI.o ${OBJECTDIR}/src/configuration_bits.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/user.o ${OBJECTDIR}/src/ADC.o

# Source Files
SOURCEFILES=src/OLED/ChrFont0.c src/OLED/FillPat.c src/OLED/OLED.c src/OLED/OledChar.c src/OLED/OledGrph.c src/OLED/SPI.c src/configuration_bits.c src/main.c src/user.c src/ADC.c
...
${OBJECTDIR}/src/ADC.o: src/ADC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/ADC.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/ADC.o.d" -o ${OBJECTDIR}/src/ADC.o src/ADC.c   -save-temps=obj -DXPRJ_PIC32MZ2048EFG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/ADC.o: src/ADC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/ADC.o.d 
	@${RM} ${OBJECTDIR}/src/ADC.o 
	@${FIXDEPS} "${OBJECTDIR}/src/ADC.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/ADC.o.d" -o ${OBJECTDIR}/src/ADC.o src/ADC.c   -save-temps=obj -DXPRJ_PIC32MZ2048EFG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
